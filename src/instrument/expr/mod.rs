...
//! compilation, stored within [crate::gather::first_pass_info]. The facts are made available
...
pub fn transform_expr<'session>(
    ...
    if let rustc_ast::ExprKind::Assign(lhs, rhs, _)
    | rustc_ast::ExprKind::AssignOp(_, lhs, rhs) = &mut expr.kind
    {
