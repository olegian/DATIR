...
fn assign_tuples() {
    ...
    expected.register_site(ExpectedSite::new(prefix_with_path_from_root(
        "assign_tuples/main.rs::main:::ENTER",
    )));
    expected.register_site(ExpectedSite::new(prefix_with_path_from_root(
        "assign_tuples/main.rs::main:::EXIT",
    )));
    ...
    expected.register_site(
        ExpectedSite::new(prefix_with_path_from_root(
            "assign_tuples/main.rs::assign_nested_tuple:::ENTER",
        ))
        .register("a.0", 0)
        .register("a.1.0", 1)
        .register("a.2", 2)
    ...
    expected.register_site(
        ExpectedSite::new(prefix_with_path_from_root(
            "assign_tuples/main.rs::assign_nested_tuple:::EXIT",
        ))
        .register("a.0", 0)
        .register("a.1.0", 1)
        .register("a.2", 2)
    ...
    expected.register_site(
        ExpectedSite::new(prefix_with_path_from_root(
            "assign_tuples/main.rs::mutate_tuple:::ENTER",
        ))
        .register("target.0", 0)
        .register("target.1", 1)
        .register("target.2", 2)
