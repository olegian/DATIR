...
fn array_with_slices() {
    ...
    expected.register_site(
        ...
        .register("arr[1][2]", 0)
        .register("arr[1][3]", 0)
        .register("arr[1].length", 1)
        .register("arr[2][0]", 0)
        .register("arr[2][1]", 0)
        .register("arr[2][2]", 0)
        .register("arr[2][3]", 0)
        .register("arr[2][4]", 0)
        .register("arr[2].length", 1)
        .register("arr.length", 2)
        .register("a", 3)
        .register("b", 4)
        .register("unused", 5),
    );
